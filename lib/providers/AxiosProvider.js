...
var AxiosProvider = (function () {
    ...
    AxiosProvider.prototype.equalTo = function (value) {
        this.params.append("equalTo", value);
        return new main_1.Query(this);
    };
    AxiosProvider.prototype.startAt = function (value) {
        this.params.append("startAt", value);
        return new main_1.Query(this);
    };
    AxiosProvider.prototype.endAt = function (value) {
    ...
    AxiosProvider.prototype.list = function (ref, toArray) {
        if (toArray === void 0) { toArray = true; }
        var url = "".concat(this.databaseUrl, "/").concat(ref.path, ".json?").concat(this.params.toString());
        return axios_1.default
            .get(url)
            .then(function (_a) {
            var data = _a.data;
            return toArray ? new Collection_1.Collection(data).toArray() : new Collection_1.Collection(data);
        });
    };
